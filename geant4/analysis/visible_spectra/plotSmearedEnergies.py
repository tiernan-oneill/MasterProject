...
'''
This script is used to plot the real and smeared energy spectra for a given isotope. 
Can loop through all isotopes in the list Isotope_list, or just plot a single isotope. 
The script will save the plots as PNG files in the figures/smeared folder.
'''
...
for Isotope in Isotope_list:
    ...
    legend.AddEntry(smeared_hist, f"Smeared Energy", "l")
    ...
    output_file_name = f"{Isotope}_smeared_energy_spectrum.png"
    folder_path = "figures/smeared"
