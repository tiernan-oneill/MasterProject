...
void TrackingAction::PreUserTrackingAction(const G4Track* track)
{
  ...
  // store energy information of particles in their respective arrays as well as the combined array
  //
  if (particle == G4Electron::Electron()){ 
      ...
      G4AnalysisManager::Instance()->FillNtupleDColumn(1, 0, Ekin);
      ...
      G4AnalysisManager::Instance()->FillNtupleDColumn(2, 0, Ekin);
      ...
      // dont include neutrinos for total energy information
